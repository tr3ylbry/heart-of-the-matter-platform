    ...
    <section className="relative overflow-hidden px-4 pb-16 pt-14 sm:px-6 lg:px-10 lg:pb-20">
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="relative z-10">
          ...
          <h1 className="max-w-3xl font-serif text-6xl font-black leading-[0.92] text-[var(--ink)] sm:text-7xl lg:text-8xl">
            Find Your Unique Voice.
          </h1>
          <div className="my-8 flex items-center gap-4" aria-hidden="true">
            <span className="h-0.5 w-36 bg-[var(--gold)]" />
        ...
        <div className="relative min-h-[420px] lg:min-h-[540px]">
          <div className="absolute inset-x-0 bottom-2 h-16 rounded-[999px] bg-[var(--cyan)]" />
